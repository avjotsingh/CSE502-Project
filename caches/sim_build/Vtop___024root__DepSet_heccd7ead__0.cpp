...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->cacheMemoryBus__DOT__invalidate_buffer 
        = ((1U & (~ (IData)(vlSelf->reset))) && ((IData)(vlSelf->m_axi_acvalid) 
                                                 && (0xdU 
                                                     == (IData)(vlSelf->m_axi_acsnoop))));
    if (vlSelf->reset) {
        vlSelf->cacheMemoryBus__DOT__invalidate_addr_buffer = 0ULL;
        ...
        vlSelf->cacheMemoryBus__DOT__invalidate_addr_buffer 
            = ((IData)(vlSelf->m_axi_acvalid) ? vlSelf->m_axi_acaddr
                : 0ULL);
        if ((0U == vlSelf->cacheMemoryBus__DOT__state)) {
            ...
            vlSelf->cacheMemoryBus__DOT__addr_buffer 
                = (((QData)((IData)(vlSelf->command_addr[
                                    (((IData)(0x3fU) 
                                      + (0x7fU & VL_SHIFTL_III(7,32,32, (IData)(vlSelf->cacheMemoryBus__DOT__busChoiceOut), 6U))) 
                                     >> 5U)])) << (
                                                   (0U 
                                                    == 
                                                    (0x1fU 
            ...
            if ((2U == vlSelf->cacheMemoryBus__DOT__state)) {
                if (vlSelf->m_axi_rvalid) {
                    VL_ASSIGNSEL_WQ(1024,64,(0x3ffU 
                                             & VL_SHIFTL_III(10,32,32, (IData)(vlSelf->cacheMemoryBus__DOT__offsetCounter), 6U)), vlSelf->cacheMemoryBus__DOT__data_buffer, vlSelf->m_axi_rdata);
