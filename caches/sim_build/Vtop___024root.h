...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_IN8(invalidate,0,0);
        VL_OUT8(invalidate_ack,0,0);
        ...
        CData/*0:0*/ directCache__DOT__invalidate;
        CData/*0:0*/ directCache__DOT__invalidate_ack;
        CData/*3:0*/ directCache__DOT__offset;
        CData/*0:0*/ directCache__DOT__curr_valid;
        CData/*0:0*/ directCache__DOT____Vlvbound_hb54154a8__0;
        ...
        QData/*63:0*/ directCache__DOT__invalidate_addr;
