...
Vtop__Syms::~Vtop__Syms()
{
    ...
    __Vhier.remove(&__Vscope_top, &__Vscope_top__data_cache);
    __Vhier.remove(&__Vscope_top, &__Vscope_top__decoder);
    __Vhier.remove(&__Vscope_top, &__Vscope_top__if_id);
    __Vhier.remove(&__Vscope_top, &__Vscope_top__instruction_cache);
    __Vhier.remove(&__Vscope_top__data_cache, &__Vscope_top__data_cache__store_modifier);
    ...
    , TOP{this, namep}
{
    ...
    __Vscope_top__alu.configure(this, name(), "top.alu", "alu", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_top__branch_predictor.configure(this, name(), "top.branch_predictor", "branch_predictor", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_top__data_cache.configure(this, name(), "top.data_cache", "data_cache", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_top__data_cache__store_modifier.configure(this, name(), "top.data_cache.store_modifier", "store_modifier", -9, VerilatedScope::SCOPE_MODULE);
    __Vscope_top__decoder.configure(this, name(), "top.decoder", "decoder", -9, VerilatedScope::SCOPE_MODULE);
    ...
    __Vhier.add(&__Vscope_top, &__Vscope_top__data_cache);
    __Vhier.add(&__Vscope_top, &__Vscope_top__decoder);
    __Vhier.add(&__Vscope_top, &__Vscope_top__if_id);
    __Vhier.add(&__Vscope_top, &__Vscope_top__instruction_cache);
    __Vhier.add(&__Vscope_top__data_cache, &__Vscope_top__data_cache__store_modifier);
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_top__alu.varInsert(__Vfinal,"ALU_FUNC3_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__alu__DOT__ALU_FUNC3_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__alu.varInsert(__Vfinal,"ALU_FUNC7_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__alu__DOT__ALU_FUNC7_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__alu.varInsert(__Vfinal,"ALU_OP_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__alu__DOT__ALU_OP_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        ...
        __Vscope_top__alu.varInsert(__Vfinal,"WORD_LENGTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__alu__DOT__WORD_LENGTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__alu.varInsert(__Vfinal,"alu_op", &(TOP.top__DOT__alu__DOT__alu_op), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,6,0);
        __Vscope_top__alu.varInsert(__Vfinal,"alu_res", &(TOP.top__DOT__alu__DOT__alu_res), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__alu.varInsert(__Vfinal,"branch_decision", &(TOP.top__DOT__alu__DOT__branch_decision), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__alu.varInsert(__Vfinal,"data1", &(TOP.top__DOT__alu__DOT__data1), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__alu.varInsert(__Vfinal,"data1_w", &(TOP.top__DOT__alu__DOT__data1_w), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__alu.varInsert(__Vfinal,"data2", &(TOP.top__DOT__alu__DOT__data2), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__alu.varInsert(__Vfinal,"data2_w", &(TOP.top__DOT__alu__DOT__data2_w), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__alu.varInsert(__Vfinal,"decision", &(TOP.top__DOT__alu__DOT__decision), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__alu.varInsert(__Vfinal,"func", &(TOP.top__DOT__alu__DOT__func), false, VLVT_UINT16,VLVD_NODIR|VLVF_PUB_RW,1 ,11,0);
        __Vscope_top__alu.varInsert(__Vfinal,"func3", &(TOP.top__DOT__alu__DOT__func3), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,2,0);
        __Vscope_top__alu.varInsert(__Vfinal,"func7", &(TOP.top__DOT__alu__DOT__func7), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,6,0);
        __Vscope_top__alu.varInsert(__Vfinal,"res", &(TOP.top__DOT__alu__DOT__res), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__alu.varInsert(__Vfinal,"shamt_5", &(TOP.top__DOT__alu__DOT__shamt_5), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,4,0);
        __Vscope_top__alu.varInsert(__Vfinal,"shamt_6", &(TOP.top__DOT__alu__DOT__shamt_6), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,5,0);
        __Vscope_top__alu.varInsert(__Vfinal,"signed_data1", &(TOP.top__DOT__alu__DOT__signed_data1), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__alu.varInsert(__Vfinal,"signed_data2", &(TOP.top__DOT__alu__DOT__signed_data2), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__alu.varInsert(__Vfinal,"temp", &(TOP.top__DOT__alu__DOT__temp), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        ...
        __Vscope_top__data_cache.varInsert(__Vfinal,"ADDR_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__data_cache__DOT__ADDR_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"DATA_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__data_cache__DOT__DATA_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"INDEX_LENGTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__data_cache__DOT__INDEX_LENGTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"OFFSET_LENGTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__data_cache__DOT__OFFSET_LENGTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"STATE_BITS", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__data_cache__DOT__STATE_BITS))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"TAG_LENGTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__data_cache__DOT__TAG_LENGTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"aaddr", &(TOP.top__DOT__data_cache__DOT__aaddr), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"avalid", &(TOP.top__DOT__data_cache__DOT__avalid), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"bus_ready", &(TOP.top__DOT__data_cache__DOT__bus_ready), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"bus_valid", &(TOP.top__DOT__data_cache__DOT__bus_valid), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"cache", &(TOP.top__DOT__data_cache__DOT__cache), false, VLVT_WDATA,VLVD_NODIR|VLVF_PUB_RW,1, 1100799,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"clk", &(TOP.top__DOT__data_cache__DOT__clk), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"command_addr", &(TOP.top__DOT__data_cache__DOT__command_addr), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"command_rready", &(TOP.top__DOT__data_cache__DOT__command_rready), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"command_store", &(TOP.top__DOT__data_cache__DOT__command_store), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"command_valid", &(TOP.top__DOT__data_cache__DOT__command_valid), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"curr_valid", &(TOP.top__DOT__data_cache__DOT__curr_valid), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"data_from_bus", &(TOP.top__DOT__data_cache__DOT__data_from_bus), false, VLVT_WDATA,VLVD_NODIR|VLVF_PUB_RW,1 ,1023,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"data_from_cpu", &(TOP.top__DOT__data_cache__DOT__data_from_cpu), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"data_to_bus", &(TOP.top__DOT__data_cache__DOT__data_to_bus), false, VLVT_WDATA,VLVD_NODIR|VLVF_PUB_RW,1 ,1023,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"data_to_cpu", &(TOP.top__DOT__data_cache__DOT__data_to_cpu), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"dirty_addr", &(TOP.top__DOT__data_cache__DOT__dirty_addr), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"dirty_data", &(TOP.top__DOT__data_cache__DOT__dirty_data), false, VLVT_WDATA,VLVD_NODIR|VLVF_PUB_RW,1 ,1023,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"hit", &(TOP.top__DOT__data_cache__DOT__hit), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"index", &(TOP.top__DOT__data_cache__DOT__index), false, VLVT_UINT16,VLVD_NODIR|VLVF_PUB_RW,1 ,9,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"load", &(TOP.top__DOT__data_cache__DOT__load), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"new_cache_data", &(TOP.top__DOT__data_cache__DOT__new_cache_data), false, VLVT_WDATA,VLVD_NODIR|VLVF_PUB_RW,1 ,1023,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"new_data", &(TOP.top__DOT__data_cache__DOT__new_data), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"next_state", &(TOP.top__DOT__data_cache__DOT__next_state), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW|VLVF_DPI_CLAY,1 ,31,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"offset", &(TOP.top__DOT__data_cache__DOT__offset), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,3,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"reset", &(TOP.top__DOT__data_cache__DOT__reset), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"state", &(TOP.top__DOT__data_cache__DOT__state), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW|VLVF_DPI_CLAY,1 ,31,0);
        __Vscope_top__data_cache.varInsert(__Vfinal,"tag", &(TOP.top__DOT__data_cache__DOT__tag), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,49,0);
        __Vscope_top__data_cache__store_modifier.varInsert(__Vfinal,"DATA_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__data_cache__DOT__store_modifier__DOT__DATA_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__data_cache__store_modifier.varInsert(__Vfinal,"REG_LOG", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__data_cache__DOT__store_modifier__DOT__REG_LOG))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__data_cache__store_modifier.varInsert(__Vfinal,"data", &(TOP.top__DOT__data_cache__DOT__store_modifier__DOT__data), false, VLVT_WDATA,VLVD_NODIR|VLVF_PUB_RW,1, 1023,0);
        __Vscope_top__data_cache__store_modifier.varInsert(__Vfinal,"final_data", &(TOP.top__DOT__data_cache__DOT__store_modifier__DOT__final_data), false, VLVT_WDATA,VLVD_NODIR|VLVF_PUB_RW,1, 1023,0);
        __Vscope_top__data_cache__store_modifier.varInsert(__Vfinal,"new_data", &(TOP.top__DOT__data_cache__DOT__store_modifier__DOT__new_data), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__data_cache__store_modifier.varInsert(__Vfinal,"sel", &(TOP.top__DOT__data_cache__DOT__store_modifier__DOT__sel), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,3,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"ALU_FUNC3_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__decoder__DOT__ALU_FUNC3_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"ALU_FUNC7_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__decoder__DOT__ALU_FUNC7_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"ALU_OP_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__decoder__DOT__ALU_OP_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"DATA_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__decoder__DOT__DATA_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"INSTR_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__decoder__DOT__INSTR_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"REG_ID_WIDTH", const_cast<void*>(static_cast<const void*>(&(TOP.top__DOT__decoder__DOT__REG_ID_WIDTH))), true, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"alu_op", &(TOP.top__DOT__decoder__DOT__alu_op), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,6,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"alu_op_", &(TOP.top__DOT__decoder__DOT__alu_op_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,6,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"alu_src", &(TOP.top__DOT__decoder__DOT__alu_src), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"alu_src_", &(TOP.top__DOT__decoder__DOT__alu_src_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"func3", &(TOP.top__DOT__decoder__DOT__func3), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,2,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"func3_", &(TOP.top__DOT__decoder__DOT__func3_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,2,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"func7", &(TOP.top__DOT__decoder__DOT__func7), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,6,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"func7_", &(TOP.top__DOT__decoder__DOT__func7_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,6,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"imm", &(TOP.top__DOT__decoder__DOT__imm), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"imm_", &(TOP.top__DOT__decoder__DOT__imm_), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"instr", &(TOP.top__DOT__decoder__DOT__instr), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"instr_", &(TOP.top__DOT__decoder__DOT__instr_), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"mem_read", &(TOP.top__DOT__decoder__DOT__mem_read), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"mem_read_", &(TOP.top__DOT__decoder__DOT__mem_read_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"mem_to_reg", &(TOP.top__DOT__decoder__DOT__mem_to_reg), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"mem_to_reg_", &(TOP.top__DOT__decoder__DOT__mem_to_reg_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"mem_write", &(TOP.top__DOT__decoder__DOT__mem_write), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"mem_write_", &(TOP.top__DOT__decoder__DOT__mem_write_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"rd", &(TOP.top__DOT__decoder__DOT__rd), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,4,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"rd_", &(TOP.top__DOT__decoder__DOT__rd_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,4,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"reg_to_pc", &(TOP.top__DOT__decoder__DOT__reg_to_pc), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"reg_to_pc_", &(TOP.top__DOT__decoder__DOT__reg_to_pc_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"reg_write", &(TOP.top__DOT__decoder__DOT__reg_write), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"reg_write_", &(TOP.top__DOT__decoder__DOT__reg_write_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"rs1", &(TOP.top__DOT__decoder__DOT__rs1), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,4,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"rs1_", &(TOP.top__DOT__decoder__DOT__rs1_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,4,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"rs2", &(TOP.top__DOT__decoder__DOT__rs2), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,4,0);
        __Vscope_top__decoder.varInsert(__Vfinal,"rs2_", &(TOP.top__DOT__decoder__DOT__rs2_), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,4,0);
