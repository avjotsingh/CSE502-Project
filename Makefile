...
#PROG=/shared/cse502/tests/project/prog1.o
...
VFILES=$(shell find -name "*.sv")
VPATHS=$(shell find . -name "*.sv" -exec dirname {} \; | sort -u)

# Convert directories into -I include paths for Verilator
INCLUDE_PATHS=$(foreach dir,$(VPATHS),-I$(dir))
