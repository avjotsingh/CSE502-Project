...
#endif
            VL_FATAL_MT("alu/alu.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    // Body
    vlSelf->alu_op = VL_RAND_RESET_I(7);
    vlSelf->func3 = VL_RAND_RESET_I(3);
    vlSelf->func7 = VL_RAND_RESET_I(7);
    vlSelf->data1 = VL_RAND_RESET_Q(64);
    vlSelf->data2 = VL_RAND_RESET_Q(64);
    vlSelf->alu_res = VL_RAND_RESET_Q(64);
    vlSelf->branch_decision = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__temp = VL_RAND_RESET_I(32);
}
